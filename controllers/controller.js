...
let getHome = (req, res) => {
    res.status(200).json({
        ...
        actions: [
            ...
            { method: "get", route: "/language/filter?difficulty='value'", path: false, query: "forBeginner", value: "easy/mid/hard" },

            { method: "get", route: "/language/sortlearning", path: false, query: false },
